<div class="container-fluid ">
    <div class="row flex-nowrap ">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-md-0 px-0 bg-white position-fixed header-custome-1 "  style="width: 18%">
            <div
                class="d-flex flex-column align-items-center align-items-sm-start ps-0 pe-0 mx-0 pt-2 text-white min-vh-100 sticky-top"
                style="    border-right: 1px solid #f5e7e7;
                background: #f2f2ff;">
                <a href="/"
                    class="d-flex align-items-center pb-3 mb-md-0 text-dark text-decoration-none mx-auto header-logo">

                    <span class="fs-5 d-none d-sm-inline"></span>
                    <img src="{{ asset('images/logo/radio_rajkot.png') }}" alt="radio-rajkot-logo-img"
                        class="img-responsive header-logo" />
                </a>
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100 pt-4d"
                    id="menu">
                    <li class="nav-item  w-100 mb-2 @if (Request::route()->getName() == 'home') nav-item-active @endif ">
                        <a href="{{ URL::to('/') }}" class="nav-link align-middle px-0">
                            <img src="{{ asset('images/icons/home.svg') }}" class="sidebar-icon"/>
                            <span class="ms-1 d-none d-sm-inline">Home</span>
                        </a>
                    </li>
                    {{-- <li class="nav-item mb-2">
                        <a href="{{ route('radio') }}" class="nav-link align-middle px-0 d-flex ">
                            <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="#1C274C" />
                            </svg><span class="ms-3  d-none d-sm-inline">
                                Radio
                            </span>
                        </a>
                    </li> --}}
                    <li
                        class="nav-item mb-2 @if (Request::route()->getName() == 'podcasts') nav-item-active @endif
                    ">
                        <a href="{{ route('podcasts') }}" class="nav-link align-middle px-0 d-flex">
                            <img src="{{ asset('images/icons/mic.svg') }}" class="sidebar-icon"/>
                            <span class="ms-3  d-none d-sm-inline">
                                Podcasts
                            </span>
                        </a>
                    </li>
                    <li class="nav-item mb-2 @if (Request::route()->getName() == 'videoes.page') nav-item-active @endif">
                        <a href="{{ route('videoes.page') }}" class="nav-link align-middle px-0 d-flex">
                            <img src="{{ asset('images/icons/videoes.svg') }}"/>
                            <span class="ms-3  d-none d-sm-inline">
                                Short Videos
                            </span>
                        </a>
                    ...
                    <li
                        class="nav-item mb-2 @if (Request::route()->getName() == 'reads' || Request::route()->getName() == 'front-blog') nav-item-active @endif

                    ">
                        <a href="{{ route('reads') }}" class="nav-link align-middle px-0 d-flex ">
                            <img src="{{ asset('images/icons/books.svg') }}" class="sidebar-icon"/>
                            <span class="ms-3  d-none d-sm-inline">
                                Blogs
                            </span>
                        </a>
                    </li>
                    <li class="nav-item  w-100 mb-2 @if (Request::route()->getName() == 'government_schemes') nav-item-active @endif ">
                        <a href="{{ route('government_schemes') }}" class="nav-link align-middle px-0">
                            <img src="{{ asset('images/icons/indian_constitution_1.png') }}" style="height: 30px" class="sidebar-icon"/>
                            <span class="ms-3 d-none d-sm-inline">Government Yojna</span>
                        </a>
                    </li>
                    <li class="nav-item  w-100 mb-2 @if (Request::route()->getName() == 'mtmf') nav-item-active @endif "
                        style="padding-left: 12px"
                        >
                        <a href="{{ route('mtmf') }}" class="nav-link align-middle px-0">
                            <img src="{{ asset('images/icons/mtmf.png') }}" style="height: 30px;" class="sidebar-icon"/>
                            <span class="ms-3 d-none d-sm-inline">MTMF</span>
                        </a>
                    </li>

                    <li class="nav-item mb-2 ">
                        <a href="#" class="nav-link align-middle px-0 d-flex ">
                            <span class="ms-0  d-none d-sm-inline text-primary">
                                Events
                            </span>
                        </a>
                    </li>
        ...
        <div class="ms-auto main-section-1 p-0" style="width: 83%;align-items: end !important;display: block;">
