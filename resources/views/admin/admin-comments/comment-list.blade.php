                            ...
                            <div class="card">
                                <div class="card-header row">
                                    ...
                                    <div class="col-sm-12 col-md-2 flex-end">
                                        <a href="{{ route('comments.create') }}" class="btn btn-primary">Add Comments</a>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            // let comment = html(`${data.comment}`).text();
                            return $("<div/>").html(data.comment).text();;
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return `<div class="d-flex align-items-center col-actions">
                                ...
                                <a href="comments/${data.id}/edit" class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" id="del_row"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit font-small-4 me-50"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></a>

                                        <div class="d-flex flex-column">
                                        <label class="form-check-label mb-50" for="customSwitch6"></label>
                                            <div class="form-check form-check-info form-switch">
                                                <input type="checkbox" class="form-check-input" data-id="${data.id}" ${data.is_verified == 1 ? 'checked' : ''} />
                                            </div>
                                        </div>
                                        <a class="me-1 destroy" id='${data.id}' >
            ...
            $(document).on('click','.form-check-input',function(){
                ...
                var url = "{{ url('/') }}" + "/admin/comment/verify";
                $.ajax({
                    url: url,
                    type: 'POST',
                    data: {
