                            ...
                            <div class="content-header row">
                                <div class="content-header-left col-md-12 mb-2">
                                    <div class="row breadcrumbs-top">
                                        <div class="col-8">
                                            <h2 class="content-header-title float-start mb-0">Interviews</h2>
                                            <div class="breadcrumb-wrapper">
                                                <ol class="breadcrumb">
                                                    <li class="breadcrumb-item active"><a
                                                            href="{{ route('interviews.index') }}">Go Back</a>
                                                    </li>
                                                </ol>
                                            </div>
                                        </div>
                            ...
                            <div class="card col-12">
                                <div class="card-header">
                                    @if (isset($interview->name))
                                        <h4 class="card-title">{{ $interview->name }}</h4>
                                    @else
                                        <h4 class="card-title">Interviews Information</h4>
                                    @endif
                                </div>
                                <div class="card-body">
                                    ...
                                    @php
                                        if (isset($interview->id)) {
                                            $url = 'admin/interviews/' . $interview->id;
                                            $method = 'PUT';
                                        } else {
                                    ...
                                    <div class="mb-1">
                                        ...
                                        {!! Form::text('name', old('name', isset($interview->name) ? $interview->name : ''), [
                                    ...
                                    <div class="mb-1">
                                        {!! Form::label('URL', null, ['class' => 'form-label ']) !!}
                                        {!! Form::text('description', old('description', isset($interview->description) ? $interview->description : ''), [
                                            'placeholder' => 'URL',
                                            'id' => 'description',
                                    ...
                                    {{-- <div class="mb-3">
                                        <label for="formFile" class="form-label">Select Item:</label>
                                    ...
                                    {{-- <div class="mb-1">
                                        <section class="full-editor">
                                            ...
                                            <p>Add Interviews Text Here you can use Editor for Font style.....</p>
                                            <div id="full-wrapper">
                                    ...
                                    <div class="mb-1">
                                        {!! Form::button(isset($interview) ? 'Update' : 'Create', ['class' => 'btn btn-primary submit']) !!}
                                    </div>
                                </div>
