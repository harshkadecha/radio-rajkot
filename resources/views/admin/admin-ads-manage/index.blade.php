                            ...
                            <div class="card">
                                <div class="card-header row">
                                    ...
                                    <div class="col-sm-12 col-md-2 flex-end">
                                        <a href="{{ route('ad-manage.create') }}" class="btn btn-primary">Add Advertisement</a>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return `<div class="d-flex align-items-center col-actions">
                                <a href="ad-manage/${data.id}/edit" class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" id="del_row">
            ...
            $(document).on("click", ".accept", function() {
                ...
                var url = "{{ url('/') }}" + "/admin/ad-manage/" + id;
                $.ajax({
                    url: url,
                    type: 'DELETE',
                    data: {
