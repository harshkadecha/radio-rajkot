                        ...
                        <div class="col-md-12 col-12">
                            <div class="content-header row">
                                <div class="content-header-left col-md-12 mb-2">
                                    <div class="row breadcrumbs-top">
                                        <div class="col-8">
                                            <h2 class="content-header-title float-start mb-0">Static Pages</h2>
                                            <div class="breadcrumb-wrapper">
                                                <ol class="breadcrumb">
                                                    <li class="breadcrumb-item active"><a
                                                            href="{{ route('static-pages.index') }}">Go Back</a>
                                                    </li>
                                                </ol>
                                            </div>
                                        </div>
                            ...
                            <div class="card col-12">
                                <div class="card-header">
                                    @if (isset($static_page->title))
                                        <h4 class="card-title">{{ $static_page->title }}</h4>
                                    @else
                                        <h4 class="card-title">Static Page Information</h4>
                                    @endif
                                </div>
                                <div class="card-body">
                                    ...
                                    @php
                                        if (isset($static_page->id)) {
                                            $url = 'admin/static-pages/' . $static_page->id;
                                            $method = 'PUT';
                                        } else {
                                    ...
                                    <div class="mb-1">
                                        ...
                                        {!! Form::text('name', old('name', isset($static_page->name) ? $static_page->name : ''), [
                                    ...
                                    <div class="mb-1">
                                        {!! Form::button(isset($static_page) ? 'Update' : 'Create', ['class' => 'btn btn-primary submit']) !!}
                                    </div>
                                </div>
...
<script src="http://cdn.syncfusion.com/16.4.0.52/js/web/ej.web.all.min.js"></script>
    ...
    <script>
        //image preview
        // $("img").hide();
        @if (isset($static_page->description))

            var txt = `{!! $static_page->description !!}`;
            $('.ql-editor').html(txt);
