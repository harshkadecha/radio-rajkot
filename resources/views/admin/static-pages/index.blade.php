                            ...
                            <div class="card">
                                <div class="card-header row">
                                    ...
                                    <div class="col-sm-12 col-md-2 flex-end">
                                        <a href="{{ route('static-pages.create') }}" class="btn btn-primary">Add Pages</a>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            var datatable = $('.datatables-basic').DataTable({
                ...
                'serverMethod': 'get',
                ajax: {
                    url: "{{ route('get_static_pages_data') }}",
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return `<div class="d-flex align-items-center col-actions">
                                <a href="static-pages/${data.id}/edit" class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" id="del_row">
            ...
            $(document).on("click", ".accept", function() {
                ...
                var url = "{{ url('/') }}" + "/admin/static-pages/" + id;
                $.ajax({
                    url: url,
                    type: 'DELETE',
                    data: {
