                        ...
                        <div class="col-md-12 col-12">
                            <div class="content-header row">
                                <div class="content-header-left col-md-12 mb-2">
                                    <div class="row breadcrumbs-top">
                                        <div class="col-8">
                                            <h2 class="content-header-title float-start mb-0">Podcasts</h2>
                                            <div class="breadcrumb-wrapper">
                                                <ol class="breadcrumb">
                                                    <li class="breadcrumb-item active"><a
                                                            href="{{ route('podcasts.index') }}">Go Back</a>
                                                    </li>
                                                </ol>
                                            </div>
                                        </div>
                            ...
                            <div class="card col-12">
                                <div class="card-header">
                                    @if (isset($podcast->name))
                                        <h4 class="card-title">{{ $podcast->name }}</h4>
                                    @else
                                        <h4 class="card-title">Podcast Information</h4>
                                    @endif
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        {!! Form::text('name', old('name', isset($podcast->name) ? $podcast->name : ''), [
                                    ...
                                    <div class="mb-1">
                                        <section class="full-editor">
                                            ...
                                            <p>Add Podcast Text Here you can use Editor for Font style.....</p>
                                            <div id="full-wrapper">
                                    ...
                                    <div class="mb-1">
                                        {!! Form::button(isset($podcast) ? 'Update' : 'Create', ['class' => 'btn btn-primary submit']) !!}
                                    </div>
                                </div>
