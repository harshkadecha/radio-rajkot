                            ...
                            <div class="card">
                                <div class="card-header row">
                                    ...
                                    <div class="col-sm-12 col-md-2 flex-end">
                                        <a href="{{ route('podcasts.create') }}" class="btn btn-primary">Add Podcasts</a>
                                    </div>
                                </div>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return `<div class="d-flex align-items-center col-actions">
                                <a href="podcasts/${data.id}/edit" class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" id="del_row">
