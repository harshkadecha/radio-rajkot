                            ...
                            <div class="card">
                                <div class="card-header row">
                                    ...
                                    <div class="col-sm-12 col-md-2 flex-end">
                                        <a href="{{ route('show.create') }}" class="btn btn-primary">Add Schedule</a>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            var datatable = $('.datatables-basic').DataTable({
                ...
                'serverMethod': 'get',
                ajax: {
                    url: "{{ route('get_show_schedule_data') }}",
                        ...
                        render: function(data, type, row) {
                            if (data != null) {
                                ...
                                <div class="avatar me-50">
                                    <img id="profileImage" class="avatar" src="{{ asset('/storage/image/show') . '/' }}${data}" alt="Logo" />
                                </div>
                            </div>`;
                            } else {
                                return "-";
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return `<div class="d-flex align-items-center col-actions">
                                <a href="show/${data.id}/edit" class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" id="del_row">
